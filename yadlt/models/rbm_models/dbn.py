...
class DeepBeliefNetwork(SupervisedModel):
    ...
    def __init__(self, rbm_layers, model_name='srbm', do_pretrain=False, main_dir='srbm/', models_dir='models/',
                 data_dir='data/', summary_dir='logs/', rbm_num_epochs=[10], rbm_gibbs_k=[1], rbm_gauss_visible=False,
